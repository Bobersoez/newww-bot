...
client.on('ready', async () => {
    client.user.setActivity(`LeonstarveG0D`)
...
client.on("message", async (msg) => {
    if (msg.guild.id !== "1060270313105002566" ) return
    const prefix = "-"
...
client.login("MTA2MDI2OTY1NDU5MDg4NjAzOQ.GIlD-T.dq9G72Sv7FD58fLGhLk1ottZvBl7t-4V_Ff3TI");